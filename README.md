# React To-Do
 Build a to-do app that can create, delete, and modify to-do items. The finished project is simple and unstyled, merely teaching how to create and extend a React project that uses build tools.

###  Objectives
* Use create-react-app to initialize a full-fledged React app.
* Create a hierarchy of class-based React components.
* Use import and export to manage scripts and assets in a modular manner.
* Manage application data by defining and manipulating state.
* Pass data down to child components using props.
* Pass functions down to child components as props.
* Work with form data by using onChange and onSubmit.
